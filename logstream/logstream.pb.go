...
type StreamLogResponse struct {
	...
	// server_exit_state is the final exit state of the server just before exiting.
	ServerExitStatus *StreamLogResponse_ServerExitStatus `protobuf:"bytes,2,opt,name=server_exit_status,json=serverExitStatus,proto3" json:"server_exit_status,omitempty"`
}
...
func (x *StreamLogResponse) GetServerExitStatus() *StreamLogResponse_ServerExitStatus {
	if x != nil {
		return x.ServerExitStatus
	}
	return nil
}
...
type StreamLogResponse_ServerExitStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StreamLogResponse_ServerExitStatus) Reset() {
	*x = StreamLogResponse_ServerExitStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *StreamLogResponse_ServerExitStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamLogResponse_ServerExitStatus) ProtoMessage() {}

func (x *StreamLogResponse_ServerExitStatus) ProtoReflect() protoreflect.Message {
	mi := &file_logstream_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreamLogResponse_ServerExitStatus.ProtoReflect.Descriptor instead.
func (*StreamLogResponse_ServerExitStatus) Descriptor() ([]byte, []int) {
	return file_logstream_proto_rawDescGZIP(), []int{1, 0}
}

func (x *StreamLogResponse_ServerExitStatus) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_logstream_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x08, 0x52, 0x03, 0x65, 0x6f, 0x66, 0x22, 0xc2, 0x01, 0x0a, 0x11, 0x53, 0x74, 0x72,
	...
	,
	...
	0x1b, 0x47, 0x65, 0x74, 0x46, 0x69, 0x72, 0x65, 0x62, 0x61, 0x73, 0x65, 0x41, 0x75, 0x74, 0x68,
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x34, 0x0a, 0x1c,
	...
	0x65, 0x6e, 0x32, 0x9f, 0x02, 0x0a, 0x09, 0x4c, 0x6f, 0x67, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0xac, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x46, 0x69, 0x72,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x6c, 0x6f, 0x67, 0x73, 0x74, 0x72,
...
var file_logstream_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_logstream_proto_goTypes = []interface{}{
	...
	(*StreamLogResponse_ServerExitStatus)(nil), // 4: api.public.logstream.StreamLogResponse.ServerExitStatus
	(*Delta)(nil),                              // 5: api.public.logstream.Delta
}
var file_logstream_proto_depIdxs = []int32{
	5, // 0: api.public.logstream.StreamLogRequest.deltas:type_name -> api.public.logstream.Delta
	4, // 1: api.public.logstream.StreamLogResponse.server_exit_status:type_name -> api.public.logstream.StreamLogResponse.ServerExitStatus
	0, // 2: api.public.logstream.LogStream.StreamLogs:input_type -> api.public.logstream.StreamLogRequest
	2, // 3: api.public.logstream.LogStream.GetFirebaseAuthToken:input_type -> api.public.logstream.GetFirebaseAuthTokenRequest
	1, // 4: api.public.logstream.LogStream.StreamLogs:output_type -> api.public.logstream.StreamLogResponse
	3, // 5: api.public.logstream.LogStream.GetFirebaseAuthToken:output_type -> api.public.logstream.GetFirebaseAuthTokenResponse
...
func file_logstream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_logstream_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StreamLogResponse_ServerExitStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
