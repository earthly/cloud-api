...
var file_secrets_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x84, 0x01, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x6f, 0x0a,
	...
	0x10, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x62,
...
var file_secrets_proto_goTypes = []interface{}{
	...
	(*CreateAccountRequest)(nil),          // 1: api.public.secrets.CreateAccountRequest
	(*CreateAccountResponse)(nil),         // 2: api.public.secrets.CreateAccountResponse
	(*ResetPasswordRequest)(nil),          // 3: api.public.secrets.ResetPasswordRequest
	(*ResetPasswordResponse)(nil),         // 4: api.public.secrets.ResetPasswordResponse
	(*AuthChallengeResponse)(nil),         // 5: api.public.secrets.AuthChallengeResponse
	(*ConnectedAccounts)(nil),             // 6: api.public.secrets.ConnectedAccounts
	(*PingResponse)(nil),                  // 7: api.public.secrets.PingResponse
	(*OrgPermissions)(nil),                // 8: api.public.secrets.OrgPermissions
	(*ListOrgPermissionsResponse)(nil),    // 9: api.public.secrets.ListOrgPermissionsResponse
	(*OrgMember)(nil),                     // 10: api.public.secrets.OrgMember
	(*ListOrgMembersResponse)(nil),        // 11: api.public.secrets.ListOrgMembersResponse
	(*UpdateOrgMemberRequest)(nil),        // 12: api.public.secrets.UpdateOrgMemberRequest
	(*CreateInvitationRequest)(nil),       // 13: api.public.secrets.CreateInvitationRequest
	(*CreateInvitationResponse)(nil),      // 14: api.public.secrets.CreateInvitationResponse
	(*OrgDetail)(nil),                     // 15: api.public.secrets.OrgDetail
	(*ListOrgsResponse)(nil),              // 16: api.public.secrets.ListOrgsResponse
	(*GetPersonalOrgRequest)(nil),         // 17: api.public.secrets.GetPersonalOrgRequest
	(*GetPersonalOrgResponse)(nil),        // 18: api.public.secrets.GetPersonalOrgResponse
	(*AuthToken)(nil),                     // 19: api.public.secrets.AuthToken
	(*ListAuthTokensResponse)(nil),        // 20: api.public.secrets.ListAuthTokensResponse
	(*OAuthConnectRequest)(nil),           // 21: api.public.secrets.OAuthConnectRequest
	(*OAuthConnectResponse)(nil),          // 22: api.public.secrets.OAuthConnectResponse
	(*LoginResponse)(nil),                 // 23: api.public.secrets.LoginResponse
	(*Project)(nil),                       // 24: api.public.secrets.Project
	(*ProjectMember)(nil),                 // 25: api.public.secrets.ProjectMember
	(*CreateProjectRequest)(nil),          // 26: api.public.secrets.CreateProjectRequest
	(*CreateProjectResponse)(nil),         // 27: api.public.secrets.CreateProjectResponse
	(*GetProjectResponse)(nil),            // 28: api.public.secrets.GetProjectResponse
	(*ListProjectsResponse)(nil),          // 29: api.public.secrets.ListProjectsResponse
	(*AddProjectMemberRequest)(nil),       // 30: api.public.secrets.AddProjectMemberRequest
	(*ListProjectMembersResponse)(nil),    // 31: api.public.secrets.ListProjectMembersResponse
	(*Secret)(nil),                        // 32: api.public.secrets.Secret
	(*ListSecretsResponse)(nil),           // 33: api.public.secrets.ListSecretsResponse
	(*SecretPermission)(nil),              // 34: api.public.secrets.SecretPermission
	(*ListSecretPermissionsResponse)(nil), // 35: api.public.secrets.ListSecretPermissionsResponse
	(*UpdateSecretPermissionRequest)(nil), // 36: api.public.secrets.UpdateSecretPermissionRequest
	(*Invitation)(nil),                    // 37: api.public.secrets.Invitation
	(*ListInvitationsResponse)(nil),       // 38: api.public.secrets.ListInvitationsResponse
	(*timestamppb.Timestamp)(nil),         // 39: google.protobuf.Timestamp
}
var file_secrets_proto_depIdxs = []int32{
	6,  // 0: api.public.secrets.PingResponse.connected_accounts:type_name -> api.public.secrets.ConnectedAccounts
	8,  // 1: api.public.secrets.ListOrgPermissionsResponse.permissions:type_name -> api.public.secrets.OrgPermissions
	10, // 2: api.public.secrets.ListOrgMembersResponse.members:type_name -> api.public.secrets.OrgMember
	10, // 3: api.public.secrets.UpdateOrgMemberRequest.member:type_name -> api.public.secrets.OrgMember
	0,  // 4: api.public.secrets.OrgDetail.type:type_name -> api.public.secrets.OrgType
	15, // 5: api.public.secrets.ListOrgsResponse.details:type_name -> api.public.secrets.OrgDetail
	15, // 6: api.public.secrets.GetPersonalOrgResponse.org:type_name -> api.public.secrets.OrgDetail
	39, // 7: api.public.secrets.AuthToken.expiry:type_name -> google.protobuf.Timestamp
	19, // 8: api.public.secrets.ListAuthTokensResponse.tokens:type_name -> api.public.secrets.AuthToken
	39, // 9: api.public.secrets.OAuthConnectResponse.expiry:type_name -> google.protobuf.Timestamp
	39, // 10: api.public.secrets.LoginResponse.expiry:type_name -> google.protobuf.Timestamp
	39, // 11: api.public.secrets.Project.created_at:type_name -> google.protobuf.Timestamp
	39, // 12: api.public.secrets.Project.modified_at:type_name -> google.protobuf.Timestamp
	39, // 13: api.public.secrets.ProjectMember.created_at:type_name -> google.protobuf.Timestamp
	39, // 14: api.public.secrets.ProjectMember.modified_at:type_name -> google.protobuf.Timestamp
	24, // 15: api.public.secrets.CreateProjectRequest.project:type_name -> api.public.secrets.Project
	24, // 16: api.public.secrets.CreateProjectResponse.project:type_name -> api.public.secrets.Project
	24, // 17: api.public.secrets.GetProjectResponse.project:type_name -> api.public.secrets.Project
	24, // 18: api.public.secrets.ListProjectsResponse.projects:type_name -> api.public.secrets.Project
	25, // 19: api.public.secrets.ListProjectMembersResponse.members:type_name -> api.public.secrets.ProjectMember
	39, // 20: api.public.secrets.Secret.created_at:type_name -> google.protobuf.Timestamp
	39, // 21: api.public.secrets.Secret.modified_at:type_name -> google.protobuf.Timestamp
	32, // 22: api.public.secrets.ListSecretsResponse.secrets:type_name -> api.public.secrets.Secret
	39, // 23: api.public.secrets.SecretPermission.created_at:type_name -> google.protobuf.Timestamp
	39, // 24: api.public.secrets.SecretPermission.modified_at:type_name -> google.protobuf.Timestamp
	34, // 25: api.public.secrets.ListSecretPermissionsResponse.secret_permissions:type_name -> api.public.secrets.SecretPermission
	39, // 26: api.public.secrets.Invitation.created_at:type_name -> google.protobuf.Timestamp
	39, // 27: api.public.secrets.Invitation.accepted_at:type_name -> google.protobuf.Timestamp
	37, // 28: api.public.secrets.ListInvitationsResponse.invitations:type_name -> api.public.secrets.Invitation
