...
var file_secrets_proto_rawDesc = []byte{
	...
	0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f,
...
var file_secrets_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_secrets_proto_goTypes = []interface{}{
	...
	(*AuthToken)(nil),                     // 16: api.public.secrets.AuthToken
	(*ListAuthTokensResponse)(nil),        // 17: api.public.secrets.ListAuthTokensResponse
	(*OAuthConnectRequest)(nil),           // 18: api.public.secrets.OAuthConnectRequest
	(*OAuthConnectResponse)(nil),          // 19: api.public.secrets.OAuthConnectResponse
	(*LoginResponse)(nil),                 // 20: api.public.secrets.LoginResponse
	(*Project)(nil),                       // 21: api.public.secrets.Project
	(*ProjectMember)(nil),                 // 22: api.public.secrets.ProjectMember
	(*CreateProjectRequest)(nil),          // 23: api.public.secrets.CreateProjectRequest
	(*CreateProjectResponse)(nil),         // 24: api.public.secrets.CreateProjectResponse
	(*GetProjectResponse)(nil),            // 25: api.public.secrets.GetProjectResponse
	(*ListProjectsResponse)(nil),          // 26: api.public.secrets.ListProjectsResponse
	(*AddProjectMemberRequest)(nil),       // 27: api.public.secrets.AddProjectMemberRequest
	(*ListProjectMembersResponse)(nil),    // 28: api.public.secrets.ListProjectMembersResponse
	(*Secret)(nil),                        // 29: api.public.secrets.Secret
	(*ListSecretsResponse)(nil),           // 30: api.public.secrets.ListSecretsResponse
	(*SecretPermission)(nil),              // 31: api.public.secrets.SecretPermission
	(*ListSecretPermissionsResponse)(nil), // 32: api.public.secrets.ListSecretPermissionsResponse
	(*UpdateSecretPermissionRequest)(nil), // 33: api.public.secrets.UpdateSecretPermissionRequest
	(*Invitation)(nil),                    // 34: api.public.secrets.Invitation
	(*ListInvitationsResponse)(nil),       // 35: api.public.secrets.ListInvitationsResponse
...
var file_secrets_proto_depIdxs = []int32{
	...
	36, // 5: api.public.secrets.AuthToken.expiry:type_name -> google.protobuf.Timestamp
	16, // 6: api.public.secrets.ListAuthTokensResponse.tokens:type_name -> api.public.secrets.AuthToken
	36, // 7: api.public.secrets.OAuthConnectResponse.expiry:type_name -> google.protobuf.Timestamp
	36, // 8: api.public.secrets.LoginResponse.expiry:type_name -> google.protobuf.Timestamp
	36, // 9: api.public.secrets.Project.created_at:type_name -> google.protobuf.Timestamp
	36, // 10: api.public.secrets.Project.modified_at:type_name -> google.protobuf.Timestamp
	36, // 11: api.public.secrets.ProjectMember.created_at:type_name -> google.protobuf.Timestamp
	36, // 12: api.public.secrets.ProjectMember.modified_at:type_name -> google.protobuf.Timestamp
	21, // 13: api.public.secrets.CreateProjectRequest.project:type_name -> api.public.secrets.Project
	21, // 14: api.public.secrets.CreateProjectResponse.project:type_name -> api.public.secrets.Project
	21, // 15: api.public.secrets.GetProjectResponse.project:type_name -> api.public.secrets.Project
	21, // 16: api.public.secrets.ListProjectsResponse.projects:type_name -> api.public.secrets.Project
	22, // 17: api.public.secrets.ListProjectMembersResponse.members:type_name -> api.public.secrets.ProjectMember
	36, // 18: api.public.secrets.Secret.created_at:type_name -> google.protobuf.Timestamp
	36, // 19: api.public.secrets.Secret.modified_at:type_name -> google.protobuf.Timestamp
	29, // 20: api.public.secrets.ListSecretsResponse.secrets:type_name -> api.public.secrets.Secret
	36, // 21: api.public.secrets.SecretPermission.created_at:type_name -> google.protobuf.Timestamp
	36, // 22: api.public.secrets.SecretPermission.modified_at:type_name -> google.protobuf.Timestamp
	31, // 23: api.public.secrets.ListSecretPermissionsResponse.secret_permissions:type_name -> api.public.secrets.SecretPermission
	36, // 24: api.public.secrets.Invitation.created_at:type_name -> google.protobuf.Timestamp
	36, // 25: api.public.secrets.Invitation.accepted_at:type_name -> google.protobuf.Timestamp
	34, // 26: api.public.secrets.ListInvitationsResponse.invitations:type_name -> api.public.secrets.Invitation
