...
var file_secrets_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x58, 0x0a, 0x09, 0x4f,
	0x72, 0x67, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x15, 0x0a, 0x06, 0x6f, 0x72, 0x67, 0x5f,
	...
	0x72, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x76,
...
var file_secrets_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_secrets_proto_goTypes = []interface{}{
	...
	(*CreateInvitationRequest)(nil),       // 8: api.public.secrets.CreateInvitationRequest
	(*CreateInvitationResponse)(nil),      // 9: api.public.secrets.CreateInvitationResponse
	(*OrgDetail)(nil),                     // 10: api.public.secrets.OrgDetail
	(*ListOrgsResponse)(nil),              // 11: api.public.secrets.ListOrgsResponse
	(*AuthToken)(nil),                     // 12: api.public.secrets.AuthToken
	(*ListAuthTokensResponse)(nil),        // 13: api.public.secrets.ListAuthTokensResponse
	(*OAuthConnectRequest)(nil),           // 14: api.public.secrets.OAuthConnectRequest
	(*OAuthConnectResponse)(nil),          // 15: api.public.secrets.OAuthConnectResponse
	(*LoginResponse)(nil),                 // 16: api.public.secrets.LoginResponse
	(*Project)(nil),                       // 17: api.public.secrets.Project
	(*ProjectMember)(nil),                 // 18: api.public.secrets.ProjectMember
	(*CreateProjectRequest)(nil),          // 19: api.public.secrets.CreateProjectRequest
	(*CreateProjectResponse)(nil),         // 20: api.public.secrets.CreateProjectResponse
	(*GetProjectResponse)(nil),            // 21: api.public.secrets.GetProjectResponse
	(*ListProjectsResponse)(nil),          // 22: api.public.secrets.ListProjectsResponse
	(*AddProjectMemberRequest)(nil),       // 23: api.public.secrets.AddProjectMemberRequest
	(*ListProjectMembersResponse)(nil),    // 24: api.public.secrets.ListProjectMembersResponse
	(*Secret)(nil),                        // 25: api.public.secrets.Secret
	(*ListSecretsResponse)(nil),           // 26: api.public.secrets.ListSecretsResponse
	(*SecretPermission)(nil),              // 27: api.public.secrets.SecretPermission
	(*ListSecretPermissionsResponse)(nil), // 28: api.public.secrets.ListSecretPermissionsResponse
	(*UpdateSecretPermissionRequest)(nil), // 29: api.public.secrets.UpdateSecretPermissionRequest
...
var file_secrets_proto_depIdxs = []int32{
	...
	10, // 2: api.public.secrets.ListOrgsResponse.details:type_name -> api.public.secrets.OrgDetail
	30, // 3: api.public.secrets.AuthToken.expiry:type_name -> google.protobuf.Timestamp
	12, // 4: api.public.secrets.ListAuthTokensResponse.tokens:type_name -> api.public.secrets.AuthToken
	30, // 5: api.public.secrets.OAuthConnectResponse.expiry:type_name -> google.protobuf.Timestamp
	30, // 6: api.public.secrets.LoginResponse.expiry:type_name -> google.protobuf.Timestamp
	30, // 7: api.public.secrets.Project.created_at:type_name -> google.protobuf.Timestamp
	30, // 8: api.public.secrets.Project.modified_at:type_name -> google.protobuf.Timestamp
	30, // 9: api.public.secrets.ProjectMember.created_at:type_name -> google.protobuf.Timestamp
	30, // 10: api.public.secrets.ProjectMember.modified_at:type_name -> google.protobuf.Timestamp
	17, // 11: api.public.secrets.CreateProjectRequest.project:type_name -> api.public.secrets.Project
	17, // 12: api.public.secrets.CreateProjectResponse.project:type_name -> api.public.secrets.Project
	17, // 13: api.public.secrets.GetProjectResponse.project:type_name -> api.public.secrets.Project
	17, // 14: api.public.secrets.ListProjectsResponse.projects:type_name -> api.public.secrets.Project
	18, // 15: api.public.secrets.ListProjectMembersResponse.members:type_name -> api.public.secrets.ProjectMember
	30, // 16: api.public.secrets.Secret.created_at:type_name -> google.protobuf.Timestamp
	30, // 17: api.public.secrets.Secret.modified_at:type_name -> google.protobuf.Timestamp
	25, // 18: api.public.secrets.ListSecretsResponse.secrets:type_name -> api.public.secrets.Secret
	30, // 19: api.public.secrets.SecretPermission.created_at:type_name -> google.protobuf.Timestamp
	30, // 20: api.public.secrets.SecretPermission.modified_at:type_name -> google.protobuf.Timestamp
	27, // 21: api.public.secrets.ListSecretPermissionsResponse.secret_permissions:type_name -> api.public.secrets.SecretPermission
