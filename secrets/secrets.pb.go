...
var file_secrets_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x98, 0x01, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74,
...
var file_secrets_proto_depIdxs = []int32{
	...
	10, // 1: api.public.secrets.ListOrgsResponse.details:type_name -> api.public.secrets.OrgDetail
	30, // 2: api.public.secrets.AuthToken.expiry:type_name -> google.protobuf.Timestamp
	12, // 3: api.public.secrets.ListAuthTokensResponse.tokens:type_name -> api.public.secrets.AuthToken
	30, // 4: api.public.secrets.OAuthConnectResponse.expiry:type_name -> google.protobuf.Timestamp
	30, // 5: api.public.secrets.LoginResponse.expiry:type_name -> google.protobuf.Timestamp
	30, // 6: api.public.secrets.Project.created_at:type_name -> google.protobuf.Timestamp
	30, // 7: api.public.secrets.Project.modified_at:type_name -> google.protobuf.Timestamp
	30, // 8: api.public.secrets.ProjectMember.created_at:type_name -> google.protobuf.Timestamp
	30, // 9: api.public.secrets.ProjectMember.modified_at:type_name -> google.protobuf.Timestamp
	17, // 10: api.public.secrets.CreateProjectRequest.project:type_name -> api.public.secrets.Project
	17, // 11: api.public.secrets.CreateProjectResponse.project:type_name -> api.public.secrets.Project
	17, // 12: api.public.secrets.GetProjectResponse.project:type_name -> api.public.secrets.Project
	17, // 13: api.public.secrets.ListProjectsResponse.projects:type_name -> api.public.secrets.Project
	18, // 14: api.public.secrets.ListProjectMembersResponse.members:type_name -> api.public.secrets.ProjectMember
	30, // 15: api.public.secrets.Secret.created_at:type_name -> google.protobuf.Timestamp
	30, // 16: api.public.secrets.Secret.modified_at:type_name -> google.protobuf.Timestamp
	25, // 17: api.public.secrets.ListSecretsResponse.secrets:type_name -> api.public.secrets.Secret
	30, // 18: api.public.secrets.SecretPermission.created_at:type_name -> google.protobuf.Timestamp
	30, // 19: api.public.secrets.SecretPermission.modified_at:type_name -> google.protobuf.Timestamp
	27, // 20: api.public.secrets.ListSecretPermissionsResponse.secret_permissions:type_name -> api.public.secrets.SecretPermission
