...
var file_pipelines_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x44, 0x6e, 0x73, 0x2a, 0xd0, 0x01, 0x0a, 0x0f, 0x53, 0x61,
	...
	0x54, 0x55, 0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x32, 0x90, 0x07, 0x0a,
	...
	0x74, 0x65, 0x6c, 0x6c, 0x69, 0x74, 0x65, 0x73, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42,
...
var file_pipelines_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_pipelines_proto_goTypes = []interface{}{
	...
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 16: api.public.pipelines.ListSatellitesResponse.SatelliteInstance
}
var file_pipelines_proto_depIdxs = []int32{
	...
	16, // 4: api.public.pipelines.ListSatellitesResponse.instances:type_name -> api.public.pipelines.ListSatellitesResponse.SatelliteInstance
	0,  // 5: api.public.pipelines.GetSatelliteResponse.status:type_name -> api.public.pipelines.SatelliteStatus
	0,  // 6: api.public.pipelines.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.pipelines.SatelliteStatus
	1,  // 7: api.public.pipelines.Pipelines.ManualBuild:input_type -> api.public.pipelines.ManualBuildRequest
	6,  // 8: api.public.pipelines.Pipelines.LaunchSatellite:input_type -> api.public.pipelines.LaunchSatelliteRequest
	8,  // 9: api.public.pipelines.Pipelines.ListSatellites:input_type -> api.public.pipelines.ListSatellitesRequest
	10, // 10: api.public.pipelines.Pipelines.UpdateSatellite:input_type -> api.public.pipelines.UpdateSatelliteRequest
	12, // 11: api.public.pipelines.Pipelines.DeleteSatellite:input_type -> api.public.pipelines.DeleteSatelliteRequest
	14, // 12: api.public.pipelines.Pipelines.GetSatellite:input_type -> api.public.pipelines.GetSatelliteRequest
	2,  // 13: api.public.pipelines.Pipelines.ManualBuild:output_type -> api.public.pipelines.ManualBuildResponse
	7,  // 14: api.public.pipelines.Pipelines.LaunchSatellite:output_type -> api.public.pipelines.LaunchSatelliteResponse
	9,  // 15: api.public.pipelines.Pipelines.ListSatellites:output_type -> api.public.pipelines.ListSatellitesResponse
	11, // 16: api.public.pipelines.Pipelines.UpdateSatellite:output_type -> api.public.pipelines.UpdateSatelliteResponse
	13, // 17: api.public.pipelines.Pipelines.DeleteSatellite:output_type -> api.public.pipelines.DeleteSatelliteResponse
	15, // 18: api.public.pipelines.Pipelines.GetSatellite:output_type -> api.public.pipelines.GetSatelliteResponse
