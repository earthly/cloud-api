...
var file_pipelines_proto_rawDesc = []byte{
	...
	0x03, 0x32, 0xa1, 0x13, 0x0a, 0x09, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x12,
	...
	0x65, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x70, 0x69, 0x70, 0x65, 0x6c,
...
var file_pipelines_proto_depIdxs = []int32{
	...
	0,  // 21: api.public.pipelines.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.pipelines.SatelliteStatus
	2,  // 22: api.public.pipelines.Pipelines.ManualBuild:input_type -> api.public.pipelines.ManualBuildRequest
	7,  // 23: api.public.pipelines.Pipelines.LaunchSatellite:input_type -> api.public.pipelines.LaunchSatelliteRequest
	9,  // 24: api.public.pipelines.Pipelines.ListSatellites:input_type -> api.public.pipelines.ListSatellitesRequest
	11, // 25: api.public.pipelines.Pipelines.UpdateSatellite:input_type -> api.public.pipelines.UpdateSatelliteRequest
	13, // 26: api.public.pipelines.Pipelines.DeleteSatellite:input_type -> api.public.pipelines.DeleteSatelliteRequest
	15, // 27: api.public.pipelines.Pipelines.GetSatellite:input_type -> api.public.pipelines.GetSatelliteRequest
	17, // 28: api.public.pipelines.Pipelines.WakeSatellite:input_type -> api.public.pipelines.WakeSatelliteRequest
	19, // 29: api.public.pipelines.Pipelines.ReserveSatellite:input_type -> api.public.pipelines.ReserveSatelliteRequest
	21, // 30: api.public.pipelines.Pipelines.ListRemoteRepos:input_type -> api.public.pipelines.ListRemoteReposRequest
	38, // 31: api.public.pipelines.Pipelines.ListRemoteOrgs:input_type -> api.public.pipelines.ListRemoteOrgsRequest
	25, // 32: api.public.pipelines.Pipelines.AddProjectRepos:input_type -> api.public.pipelines.AddProjectReposRequest
	27, // 33: api.public.pipelines.Pipelines.RemoveProjectRepo:input_type -> api.public.pipelines.RemoveProjectRepoRequest
	29, // 34: api.public.pipelines.Pipelines.ListProjectRepos:input_type -> api.public.pipelines.ListProjectReposRequest
	36, // 35: api.public.pipelines.Pipelines.ListRemotePipelines:input_type -> api.public.pipelines.ListRemotePipelinesRequest
	41, // 36: api.public.pipelines.Pipelines.ListPipelines:input_type -> api.public.pipelines.ListPipelinesRequest
	43, // 37: api.public.pipelines.Pipelines.AddPipelines:input_type -> api.public.pipelines.AddPipelinesRequest
	45, // 38: api.public.pipelines.Pipelines.RemovePipeline:input_type -> api.public.pipelines.RemovePipelineRequest
	3,  // 39: api.public.pipelines.Pipelines.ManualBuild:output_type -> api.public.pipelines.ManualBuildResponse
	8,  // 40: api.public.pipelines.Pipelines.LaunchSatellite:output_type -> api.public.pipelines.LaunchSatelliteResponse
	10, // 41: api.public.pipelines.Pipelines.ListSatellites:output_type -> api.public.pipelines.ListSatellitesResponse
	12, // 42: api.public.pipelines.Pipelines.UpdateSatellite:output_type -> api.public.pipelines.UpdateSatelliteResponse
	14, // 43: api.public.pipelines.Pipelines.DeleteSatellite:output_type -> api.public.pipelines.DeleteSatelliteResponse
	16, // 44: api.public.pipelines.Pipelines.GetSatellite:output_type -> api.public.pipelines.GetSatelliteResponse
	18, // 45: api.public.pipelines.Pipelines.WakeSatellite:output_type -> api.public.pipelines.WakeSatelliteResponse
	20, // 46: api.public.pipelines.Pipelines.ReserveSatellite:output_type -> api.public.pipelines.ReserveSatelliteResponse
	23, // 47: api.public.pipelines.Pipelines.ListRemoteRepos:output_type -> api.public.pipelines.ListRemoteReposResponse
	40, // 48: api.public.pipelines.Pipelines.ListRemoteOrgs:output_type -> api.public.pipelines.ListRemoteOrgsResponse
	26, // 49: api.public.pipelines.Pipelines.AddProjectRepos:output_type -> api.public.pipelines.AddProjectReposResponse
	28, // 50: api.public.pipelines.Pipelines.RemoveProjectRepo:output_type -> api.public.pipelines.RemoveProjectRepoResponse
	30, // 51: api.public.pipelines.Pipelines.ListProjectRepos:output_type -> api.public.pipelines.ListProjectReposResponse
	37, // 52: api.public.pipelines.Pipelines.ListRemotePipelines:output_type -> api.public.pipelines.ListRemotePipelinesResponse
	42, // 53: api.public.pipelines.Pipelines.ListPipelines:output_type -> api.public.pipelines.ListPipelinesResponse
	44, // 54: api.public.pipelines.Pipelines.AddPipelines:output_type -> api.public.pipelines.AddPipelinesResponse
	46, // 55: api.public.pipelines.Pipelines.RemovePipeline:output_type -> api.public.pipelines.RemovePipelineResponse
