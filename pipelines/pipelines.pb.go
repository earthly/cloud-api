...
var file_pipelines_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x73, 0x69, 0x6e, 0x67, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2a, 0x87, 0x02, 0x0a,
	...
	0x59, 0x50, 0x45, 0x5f, 0x50, 0x52, 0x10, 0x03, 0x32, 0xf4, 0x0e, 0x0a, 0x09, 0x50, 0x69, 0x70,
	...
	0x2f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x50,
	...
	0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x42,
...
var file_pipelines_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_pipelines_proto_goTypes = []interface{}{
	...
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 37: api.public.pipelines.ListSatellitesResponse.SatelliteInstance
...
var file_pipelines_proto_depIdxs = []int32{
	...
	37, // 4: api.public.pipelines.ListSatellitesResponse.instances:type_name -> api.public.pipelines.ListSatellitesResponse.SatelliteInstance
	...
	38, // 8: api.public.pipelines.ProjectRepo.created_at:type_name -> google.protobuf.Timestamp
	...
	19, // 24: api.public.pipelines.Pipelines.ReserveSatellite:input_type -> api.public.pipelines.ReserveSatelliteRequest
	21, // 25: api.public.pipelines.Pipelines.ListRemoteRepos:input_type -> api.public.pipelines.ListRemoteReposRequest
	25, // 26: api.public.pipelines.Pipelines.AddProjectRepos:input_type -> api.public.pipelines.AddProjectReposRequest
	27, // 27: api.public.pipelines.Pipelines.RemoveProjectRepo:input_type -> api.public.pipelines.RemoveProjectRepoRequest
	29, // 28: api.public.pipelines.Pipelines.ListProjectRepos:input_type -> api.public.pipelines.ListProjectReposRequest
	35, // 29: api.public.pipelines.Pipelines.ListRemotePipelines:input_type -> api.public.pipelines.ListRemotePipelinesRequest
	...
	20, // 37: api.public.pipelines.Pipelines.ReserveSatellite:output_type -> api.public.pipelines.ReserveSatelliteResponse
	23, // 38: api.public.pipelines.Pipelines.ListRemoteRepos:output_type -> api.public.pipelines.ListRemoteReposResponse
	26, // 39: api.public.pipelines.Pipelines.AddProjectRepos:output_type -> api.public.pipelines.AddProjectReposResponse
	28, // 40: api.public.pipelines.Pipelines.RemoveProjectRepo:output_type -> api.public.pipelines.RemoveProjectRepoResponse
	30, // 41: api.public.pipelines.Pipelines.ListProjectRepos:output_type -> api.public.pipelines.ListProjectReposResponse
	36, // 42: api.public.pipelines.Pipelines.ListRemotePipelines:output_type -> api.public.pipelines.ListRemotePipelinesResponse
