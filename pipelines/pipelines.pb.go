...
var file_pipelines_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x22, 0xd2, 0x01, 0x0a, 0x08, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x12,
	...
	0x67, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x41, 0x0a, 0x15, 0x45, 0x61, 0x72, 0x74, 0x68,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x5e, 0x0a, 0x1a, 0x4c, 0x69,
	...
	0x6f, 0x72, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6f, 0x72, 0x67, 0x12, 0x1a,
	0x0a, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x22, 0xaf, 0x01, 0x0a, 0x1b, 0x4c,
	...
	0x4f, 0x72, 0x67, 0x73, 0x2a, 0x87, 0x02, 0x0a, 0x0f, 0x53, 0x61, 0x74, 0x65, 0x6c, 0x6c, 0x69,
	...
	0x32, 0xfe, 0x0f, 0x0a, 0x09, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x12, 0xab,
	...
	0x65, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73,
...
var file_pipelines_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_pipelines_proto_goTypes = []interface{}{
	...
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 40: api.public.pipelines.ListSatellitesResponse.SatelliteInstance
...
var file_pipelines_proto_depIdxs = []int32{
	...
	40, // 4: api.public.pipelines.ListSatellitesResponse.instances:type_name -> api.public.pipelines.ListSatellitesResponse.SatelliteInstance
	...
	41, // 8: api.public.pipelines.ProjectRepo.created_at:type_name -> google.protobuf.Timestamp
	...
	0,  // 17: api.public.pipelines.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.pipelines.SatelliteStatus
	2,  // 18: api.public.pipelines.Pipelines.ManualBuild:input_type -> api.public.pipelines.ManualBuildRequest
	7,  // 19: api.public.pipelines.Pipelines.LaunchSatellite:input_type -> api.public.pipelines.LaunchSatelliteRequest
	9,  // 20: api.public.pipelines.Pipelines.ListSatellites:input_type -> api.public.pipelines.ListSatellitesRequest
	11, // 21: api.public.pipelines.Pipelines.UpdateSatellite:input_type -> api.public.pipelines.UpdateSatelliteRequest
	13, // 22: api.public.pipelines.Pipelines.DeleteSatellite:input_type -> api.public.pipelines.DeleteSatelliteRequest
	15, // 23: api.public.pipelines.Pipelines.GetSatellite:input_type -> api.public.pipelines.GetSatelliteRequest
	17, // 24: api.public.pipelines.Pipelines.WakeSatellite:input_type -> api.public.pipelines.WakeSatelliteRequest
	19, // 25: api.public.pipelines.Pipelines.ReserveSatellite:input_type -> api.public.pipelines.ReserveSatelliteRequest
	21, // 26: api.public.pipelines.Pipelines.ListRemoteRepos:input_type -> api.public.pipelines.ListRemoteReposRequest
	37, // 27: api.public.pipelines.Pipelines.ListRemoteOrgs:input_type -> api.public.pipelines.ListRemoteOrgsRequest
	25, // 28: api.public.pipelines.Pipelines.AddProjectRepos:input_type -> api.public.pipelines.AddProjectReposRequest
	27, // 29: api.public.pipelines.Pipelines.RemoveProjectRepo:input_type -> api.public.pipelines.RemoveProjectRepoRequest
	29, // 30: api.public.pipelines.Pipelines.ListProjectRepos:input_type -> api.public.pipelines.ListProjectReposRequest
	35, // 31: api.public.pipelines.Pipelines.ListRemotePipelines:input_type -> api.public.pipelines.ListRemotePipelinesRequest
	3,  // 32: api.public.pipelines.Pipelines.ManualBuild:output_type -> api.public.pipelines.ManualBuildResponse
	8,  // 33: api.public.pipelines.Pipelines.LaunchSatellite:output_type -> api.public.pipelines.LaunchSatelliteResponse
	10, // 34: api.public.pipelines.Pipelines.ListSatellites:output_type -> api.public.pipelines.ListSatellitesResponse
	12, // 35: api.public.pipelines.Pipelines.UpdateSatellite:output_type -> api.public.pipelines.UpdateSatelliteResponse
	14, // 36: api.public.pipelines.Pipelines.DeleteSatellite:output_type -> api.public.pipelines.DeleteSatelliteResponse
	16, // 37: api.public.pipelines.Pipelines.GetSatellite:output_type -> api.public.pipelines.GetSatelliteResponse
	18, // 38: api.public.pipelines.Pipelines.WakeSatellite:output_type -> api.public.pipelines.WakeSatelliteResponse
	20, // 39: api.public.pipelines.Pipelines.ReserveSatellite:output_type -> api.public.pipelines.ReserveSatelliteResponse
	23, // 40: api.public.pipelines.Pipelines.ListRemoteRepos:output_type -> api.public.pipelines.ListRemoteReposResponse
	39, // 41: api.public.pipelines.Pipelines.ListRemoteOrgs:output_type -> api.public.pipelines.ListRemoteOrgsResponse
	26, // 42: api.public.pipelines.Pipelines.AddProjectRepos:output_type -> api.public.pipelines.AddProjectReposResponse
	28, // 43: api.public.pipelines.Pipelines.RemoveProjectRepo:output_type -> api.public.pipelines.RemoveProjectRepoResponse
	30, // 44: api.public.pipelines.Pipelines.ListProjectRepos:output_type -> api.public.pipelines.ListProjectReposResponse
	36, // 45: api.public.pipelines.Pipelines.ListRemotePipelines:output_type -> api.public.pipelines.ListRemotePipelinesResponse
