...
var file_pipelines_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6f, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x2a, 0xd0, 0x01, 0x0a, 0x0f, 0x53,
	...
	0x41, 0x54, 0x55, 0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x05, 0x32, 0x9f, 0x08,
	...
	0x76, 0x30, 0x2f, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x2f, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x42,
...
var file_pipelines_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_pipelines_proto_goTypes = []interface{}{
	...
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 19: api.public.pipelines.ListSatellitesResponse.SatelliteInstance
}
var file_pipelines_proto_depIdxs = []int32{
	...
	19, // 4: api.public.pipelines.ListSatellitesResponse.instances:type_name -> api.public.pipelines.ListSatellitesResponse.SatelliteInstance
	...
	16, // 14: api.public.pipelines.Pipelines.ListRemoteRepos:input_type -> api.public.pipelines.ListRemoteReposRequest
	2,  // 15: api.public.pipelines.Pipelines.ManualBuild:output_type -> api.public.pipelines.ManualBuildResponse
	7,  // 16: api.public.pipelines.Pipelines.LaunchSatellite:output_type -> api.public.pipelines.LaunchSatelliteResponse
	9,  // 17: api.public.pipelines.Pipelines.ListSatellites:output_type -> api.public.pipelines.ListSatellitesResponse
	11, // 18: api.public.pipelines.Pipelines.UpdateSatellite:output_type -> api.public.pipelines.UpdateSatelliteResponse
	13, // 19: api.public.pipelines.Pipelines.DeleteSatellite:output_type -> api.public.pipelines.DeleteSatelliteResponse
	15, // 20: api.public.pipelines.Pipelines.GetSatellite:output_type -> api.public.pipelines.GetSatelliteResponse
	18, // 21: api.public.pipelines.Pipelines.ListRemoteRepos:output_type -> api.public.pipelines.ListRemoteReposResponse
