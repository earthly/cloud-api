...
var file_pipelines_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x09, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x22, 0x16, 0x0a, 0x14,
	0x41, 0x64, 0x64, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x38, 0x0a, 0x15, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x69,
	...
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x49, 0x64, 0x22, 0x18,
	0x0a, 0x16, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0x87, 0x02, 0x0a, 0x0f, 0x53, 0x61, 0x74,
	...
	0x10, 0x07, 0x2a, 0x70, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x54, 0x79, 0x70,
...
var file_pipelines_proto_depIdxs = []int32{
	...
	0,  // 22: api.public.pipelines.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.pipelines.SatelliteStatus
	2,  // 23: api.public.pipelines.Pipelines.ManualBuild:input_type -> api.public.pipelines.ManualBuildRequest
	7,  // 24: api.public.pipelines.Pipelines.LaunchSatellite:input_type -> api.public.pipelines.LaunchSatelliteRequest
	9,  // 25: api.public.pipelines.Pipelines.ListSatellites:input_type -> api.public.pipelines.ListSatellitesRequest
	11, // 26: api.public.pipelines.Pipelines.UpdateSatellite:input_type -> api.public.pipelines.UpdateSatelliteRequest
	13, // 27: api.public.pipelines.Pipelines.DeleteSatellite:input_type -> api.public.pipelines.DeleteSatelliteRequest
	15, // 28: api.public.pipelines.Pipelines.GetSatellite:input_type -> api.public.pipelines.GetSatelliteRequest
	17, // 29: api.public.pipelines.Pipelines.WakeSatellite:input_type -> api.public.pipelines.WakeSatelliteRequest
	19, // 30: api.public.pipelines.Pipelines.ReserveSatellite:input_type -> api.public.pipelines.ReserveSatelliteRequest
	21, // 31: api.public.pipelines.Pipelines.ListRemoteRepos:input_type -> api.public.pipelines.ListRemoteReposRequest
	38, // 32: api.public.pipelines.Pipelines.ListRemoteOrgs:input_type -> api.public.pipelines.ListRemoteOrgsRequest
	25, // 33: api.public.pipelines.Pipelines.AddProjectRepos:input_type -> api.public.pipelines.AddProjectReposRequest
	27, // 34: api.public.pipelines.Pipelines.RemoveProjectRepo:input_type -> api.public.pipelines.RemoveProjectRepoRequest
	29, // 35: api.public.pipelines.Pipelines.ListProjectRepos:input_type -> api.public.pipelines.ListProjectReposRequest
	36, // 36: api.public.pipelines.Pipelines.ListRemotePipelines:input_type -> api.public.pipelines.ListRemotePipelinesRequest
	41, // 37: api.public.pipelines.Pipelines.ListPipelines:input_type -> api.public.pipelines.ListPipelinesRequest
	43, // 38: api.public.pipelines.Pipelines.AddPipelines:input_type -> api.public.pipelines.AddPipelinesRequest
	45, // 39: api.public.pipelines.Pipelines.RemovePipeline:input_type -> api.public.pipelines.RemovePipelineRequest
	3,  // 40: api.public.pipelines.Pipelines.ManualBuild:output_type -> api.public.pipelines.ManualBuildResponse
	8,  // 41: api.public.pipelines.Pipelines.LaunchSatellite:output_type -> api.public.pipelines.LaunchSatelliteResponse
	10, // 42: api.public.pipelines.Pipelines.ListSatellites:output_type -> api.public.pipelines.ListSatellitesResponse
	12, // 43: api.public.pipelines.Pipelines.UpdateSatellite:output_type -> api.public.pipelines.UpdateSatelliteResponse
	14, // 44: api.public.pipelines.Pipelines.DeleteSatellite:output_type -> api.public.pipelines.DeleteSatelliteResponse
	16, // 45: api.public.pipelines.Pipelines.GetSatellite:output_type -> api.public.pipelines.GetSatelliteResponse
	18, // 46: api.public.pipelines.Pipelines.WakeSatellite:output_type -> api.public.pipelines.WakeSatelliteResponse
	20, // 47: api.public.pipelines.Pipelines.ReserveSatellite:output_type -> api.public.pipelines.ReserveSatelliteResponse
	23, // 48: api.public.pipelines.Pipelines.ListRemoteRepos:output_type -> api.public.pipelines.ListRemoteReposResponse
	40, // 49: api.public.pipelines.Pipelines.ListRemoteOrgs:output_type -> api.public.pipelines.ListRemoteOrgsResponse
	26, // 50: api.public.pipelines.Pipelines.AddProjectRepos:output_type -> api.public.pipelines.AddProjectReposResponse
	28, // 51: api.public.pipelines.Pipelines.RemoveProjectRepo:output_type -> api.public.pipelines.RemoveProjectRepoResponse
	30, // 52: api.public.pipelines.Pipelines.ListProjectRepos:output_type -> api.public.pipelines.ListProjectReposResponse
	37, // 53: api.public.pipelines.Pipelines.ListRemotePipelines:output_type -> api.public.pipelines.ListRemotePipelinesResponse
	42, // 54: api.public.pipelines.Pipelines.ListPipelines:output_type -> api.public.pipelines.ListPipelinesResponse
	44, // 55: api.public.pipelines.Pipelines.AddPipelines:output_type -> api.public.pipelines.AddPipelinesResponse
	46, // 56: api.public.pipelines.Pipelines.RemovePipeline:output_type -> api.public.pipelines.RemovePipelineResponse
