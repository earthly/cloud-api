...
var file_compute_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x63, 0x0a, 0x19, 0x53, 0x61, 0x74,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6f, 0x70, 0x4c, 0x6f, 0x61, 0x64, 0x22, 0x1c,
	...
	0x4e, 0x47, 0x10, 0x09, 0x32, 0xfb, 0x0a, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65,
...
var file_compute_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_compute_proto_goTypes = []interface{}{
	...
	(*SatelliteHeartbeatRequest)(nil),                // 23: api.public.compute.SatelliteHeartbeatRequest
	(*SatelliteHeartbeatResponse)(nil),               // 24: api.public.compute.SatelliteHeartbeatResponse
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 25: api.public.compute.ListSatellitesResponse.SatelliteInstance
	(*ReserveSatelliteRequest_Metadata)(nil),         // 26: api.public.compute.ReserveSatelliteRequest.Metadata
...
var file_compute_proto_depIdxs = []int32{
	...
	25, // 1: api.public.compute.ListSatellitesResponse.instances:type_name -> api.public.compute.ListSatellitesResponse.SatelliteInstance
	0,  // 2: api.public.compute.GetSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	27, // 3: api.public.compute.GetSatelliteResponse.cache_retention:type_name -> google.protobuf.Duration
	28, // 4: api.public.compute.GetSatelliteResponse.last_used:type_name -> google.protobuf.Timestamp
	18, // 5: api.public.compute.GetSatelliteResponse.certificate:type_name -> api.public.compute.TLSCertificate
	27, // 6: api.public.compute.WakeSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	0,  // 7: api.public.compute.WakeSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	27, // 8: api.public.compute.SleepSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	0,  // 9: api.public.compute.SleepSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	27, // 10: api.public.compute.ReserveSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	26, // 11: api.public.compute.ReserveSatelliteRequest.metadata:type_name -> api.public.compute.ReserveSatelliteRequest.Metadata
	...
	0,  // 14: api.public.compute.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.compute.SatelliteStatus
	27, // 15: api.public.compute.ListSatellitesResponse.SatelliteInstance.cache_retention:type_name -> google.protobuf.Duration
	28, // 16: api.public.compute.ListSatellitesResponse.SatelliteInstance.last_used:type_name -> google.protobuf.Timestamp
	5,  // 17: api.public.compute.ListSatellitesResponse.SatelliteInstance.specs:type_name -> api.public.compute.SatelliteSpecs
	1,  // 18: api.public.compute.Compute.LaunchSatellite:input_type -> api.public.compute.LaunchSatelliteRequest
	3,  // 19: api.public.compute.Compute.ListSatellites:input_type -> api.public.compute.ListSatellitesRequest
	6,  // 20: api.public.compute.Compute.UpdateSatellite:input_type -> api.public.compute.UpdateSatelliteRequest
	8,  // 21: api.public.compute.Compute.DeleteSatellite:input_type -> api.public.compute.DeleteSatelliteRequest
	10, // 22: api.public.compute.Compute.GetSatellite:input_type -> api.public.compute.GetSatelliteRequest
	19, // 23: api.public.compute.Compute.RegisterSatellite:input_type -> api.public.compute.RegisterSatelliteRequest
	21, // 24: api.public.compute.Compute.DeregisterSatellite:input_type -> api.public.compute.DeregisterSatelliteRequest
	23, // 25: api.public.compute.Compute.SatelliteHeartbeat:input_type -> api.public.compute.SatelliteHeartbeatRequest
	12, // 26: api.public.compute.Compute.WakeSatellite:input_type -> api.public.compute.WakeSatelliteRequest
	14, // 27: api.public.compute.Compute.SleepSatellite:input_type -> api.public.compute.SleepSatelliteRequest
	16, // 28: api.public.compute.Compute.ReserveSatellite:input_type -> api.public.compute.ReserveSatelliteRequest
	2,  // 29: api.public.compute.Compute.LaunchSatellite:output_type -> api.public.compute.LaunchSatelliteResponse
	4,  // 30: api.public.compute.Compute.ListSatellites:output_type -> api.public.compute.ListSatellitesResponse
	7,  // 31: api.public.compute.Compute.UpdateSatellite:output_type -> api.public.compute.UpdateSatelliteResponse
	9,  // 32: api.public.compute.Compute.DeleteSatellite:output_type -> api.public.compute.DeleteSatelliteResponse
	11, // 33: api.public.compute.Compute.GetSatellite:output_type -> api.public.compute.GetSatelliteResponse
	20, // 34: api.public.compute.Compute.RegisterSatellite:output_type -> api.public.compute.RegisterSatelliteResponse
	22, // 35: api.public.compute.Compute.DeregisterSatellite:output_type -> api.public.compute.DeregisterSatelliteResponse
	24, // 36: api.public.compute.Compute.SatelliteHeartbeat:output_type -> api.public.compute.SatelliteHeartbeatResponse
	13, // 37: api.public.compute.Compute.WakeSatellite:output_type -> api.public.compute.WakeSatelliteResponse
	15, // 38: api.public.compute.Compute.SleepSatellite:output_type -> api.public.compute.SleepSatelliteResponse
	17, // 39: api.public.compute.Compute.ReserveSatellite:output_type -> api.public.compute.ReserveSatelliteResponse
