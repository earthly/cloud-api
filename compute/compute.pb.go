...
type RegisterSatelliteResponse struct {
	...
	CheckedReachability bool   `protobuf:"varint,2,opt,name=checked_reachability,json=checkedReachability,proto3" json:"checked_reachability,omitempty"`
...
func (x *RegisterSatelliteResponse) GetRegistered() bool {
	if x != nil {
		return x.Registered
	}
	return false
...
func (x *RegisterSatelliteResponse) GetCheckedReachability() bool {
	if x != nil {
		return x.CheckedReachability
	}
	return false
}
...
func (x *DeregisterSatelliteRequest) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
func (x *DeregisterSatelliteRequest) GetSatelliteName() string {
	if x != nil {
		return x.SatelliteName
	}
	return ""
...
var file_compute_proto_rawDesc = []byte{
	...
	0x50, 0x6f, 0x72, 0x74, 0x22, 0x9d, 0x01, 0x0a, 0x19, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	...
	0x65, 0x64, 0x12, 0x31, 0x0a, 0x14, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64, 0x5f, 0x72, 0x65,
	0x61, 0x63, 0x68, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x13, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64, 0x52, 0x65, 0x61, 0x63, 0x68, 0x61, 0x62,
	0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x2d, 0x0a, 0x12, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x89, 0x01, 0x0a, 0x1a, 0x44, 0x65, 0x72, 0x65, 0x67, 0x69, 0x73,
	...
	0x6e, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x72,
