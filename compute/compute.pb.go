...
var file_compute_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x05, 0x73, 0x70, 0x65, 0x63, 0x73, 0x22, 0xbb, 0x01, 0x0a, 0x0e, 0x53, 0x61, 0x74,
	...
	0x61, 0x6d, 0x65, 0x22, 0x9f, 0x06, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x61, 0x74, 0x65, 0x6c,
	...
	0x74, 0x65, 0x52, 0x0b, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x4a,
	...
	0x44, 0x41, 0x54, 0x49, 0x4e, 0x47, 0x10, 0x09, 0x32, 0xfb, 0x0a, 0x0a, 0x07, 0x43, 0x6f, 0x6d,
	...
	0x65, 0x53, 0x61, 0x74, 0x65, 0x6c, 0x6c, 0x69, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x63, 0x6f, 0x6d, 0x70,
...
var file_compute_proto_goTypes = []interface{}{
	...
	(*SatelliteSpecs)(nil),                           // 5: api.public.compute.SatelliteSpecs
	...
	(*TLSCertificate)(nil),                           // 18: api.public.compute.TLSCertificate
	(*RegisterSatelliteRequest)(nil),                 // 19: api.public.compute.RegisterSatelliteRequest
	(*RegisterSatelliteResponse)(nil),                // 20: api.public.compute.RegisterSatelliteResponse
	(*DeregisterSatelliteRequest)(nil),               // 21: api.public.compute.DeregisterSatelliteRequest
	(*DeregisterSatelliteResponse)(nil),              // 22: api.public.compute.DeregisterSatelliteResponse
	(*BuildkitSession)(nil),                          // 23: api.public.compute.BuildkitSession
	(*SatelliteHeartbeatRequest)(nil),                // 24: api.public.compute.SatelliteHeartbeatRequest
	(*SatelliteHeartbeatResponse)(nil),               // 25: api.public.compute.SatelliteHeartbeatResponse
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 26: api.public.compute.ListSatellitesResponse.SatelliteInstance
	(*ReserveSatelliteRequest_Metadata)(nil),         // 27: api.public.compute.ReserveSatelliteRequest.Metadata
...
var file_compute_proto_depIdxs = []int32{
	...
	26, // 1: api.public.compute.ListSatellitesResponse.instances:type_name -> api.public.compute.ListSatellitesResponse.SatelliteInstance
	0,  // 2: api.public.compute.GetSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	28, // 3: api.public.compute.GetSatelliteResponse.cache_retention:type_name -> google.protobuf.Duration
	29, // 4: api.public.compute.GetSatelliteResponse.last_used:type_name -> google.protobuf.Timestamp
	18, // 5: api.public.compute.GetSatelliteResponse.certificate:type_name -> api.public.compute.TLSCertificate
	28, // 6: api.public.compute.WakeSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	0,  // 7: api.public.compute.WakeSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	28, // 8: api.public.compute.SleepSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	0,  // 9: api.public.compute.SleepSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	28, // 10: api.public.compute.ReserveSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	27, // 11: api.public.compute.ReserveSatelliteRequest.metadata:type_name -> api.public.compute.ReserveSatelliteRequest.Metadata
	0,  // 12: api.public.compute.ReserveSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	18, // 13: api.public.compute.RegisterSatelliteRequest.certificate:type_name -> api.public.compute.TLSCertificate
	29, // 14: api.public.compute.BuildkitSession.started_at:type_name -> google.protobuf.Timestamp
	29, // 15: api.public.compute.BuildkitSession.ended_at:type_name -> google.protobuf.Timestamp
	28, // 16: api.public.compute.SatelliteHeartbeatRequest.duration_idle:type_name -> google.protobuf.Duration
	23, // 17: api.public.compute.SatelliteHeartbeatRequest.session_history:type_name -> api.public.compute.BuildkitSession
	0,  // 18: api.public.compute.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.compute.SatelliteStatus
	28, // 19: api.public.compute.ListSatellitesResponse.SatelliteInstance.cache_retention:type_name -> google.protobuf.Duration
	29, // 20: api.public.compute.ListSatellitesResponse.SatelliteInstance.last_used:type_name -> google.protobuf.Timestamp
	5,  // 21: api.public.compute.ListSatellitesResponse.SatelliteInstance.specs:type_name -> api.public.compute.SatelliteSpecs
	1,  // 22: api.public.compute.Compute.LaunchSatellite:input_type -> api.public.compute.LaunchSatelliteRequest
	3,  // 23: api.public.compute.Compute.ListSatellites:input_type -> api.public.compute.ListSatellitesRequest
	6,  // 24: api.public.compute.Compute.UpdateSatellite:input_type -> api.public.compute.UpdateSatelliteRequest
	8,  // 25: api.public.compute.Compute.DeleteSatellite:input_type -> api.public.compute.DeleteSatelliteRequest
	10, // 26: api.public.compute.Compute.GetSatellite:input_type -> api.public.compute.GetSatelliteRequest
	19, // 27: api.public.compute.Compute.RegisterSatellite:input_type -> api.public.compute.RegisterSatelliteRequest
	21, // 28: api.public.compute.Compute.DeregisterSatellite:input_type -> api.public.compute.DeregisterSatelliteRequest
	24, // 29: api.public.compute.Compute.SatelliteHeartbeat:input_type -> api.public.compute.SatelliteHeartbeatRequest
	12, // 30: api.public.compute.Compute.WakeSatellite:input_type -> api.public.compute.WakeSatelliteRequest
	14, // 31: api.public.compute.Compute.SleepSatellite:input_type -> api.public.compute.SleepSatelliteRequest
	16, // 32: api.public.compute.Compute.ReserveSatellite:input_type -> api.public.compute.ReserveSatelliteRequest
	2,  // 33: api.public.compute.Compute.LaunchSatellite:output_type -> api.public.compute.LaunchSatelliteResponse
	4,  // 34: api.public.compute.Compute.ListSatellites:output_type -> api.public.compute.ListSatellitesResponse
	7,  // 35: api.public.compute.Compute.UpdateSatellite:output_type -> api.public.compute.UpdateSatelliteResponse
	9,  // 36: api.public.compute.Compute.DeleteSatellite:output_type -> api.public.compute.DeleteSatelliteResponse
	11, // 37: api.public.compute.Compute.GetSatellite:output_type -> api.public.compute.GetSatelliteResponse
	20, // 38: api.public.compute.Compute.RegisterSatellite:output_type -> api.public.compute.RegisterSatelliteResponse
	22, // 39: api.public.compute.Compute.DeregisterSatellite:output_type -> api.public.compute.DeregisterSatelliteResponse
	25, // 40: api.public.compute.Compute.SatelliteHeartbeat:output_type -> api.public.compute.SatelliteHeartbeatResponse
	13, // 41: api.public.compute.Compute.WakeSatellite:output_type -> api.public.compute.WakeSatelliteResponse
	15, // 42: api.public.compute.Compute.SleepSatellite:output_type -> api.public.compute.SleepSatelliteResponse
	17, // 43: api.public.compute.Compute.ReserveSatellite:output_type -> api.public.compute.ReserveSatelliteResponse
