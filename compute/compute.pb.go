...
var file_compute_proto_rawDesc = []byte{
	...
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x9f, 0x06, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x61, 0x74,
	...
	0x65, 0x4a, 0x04, 0x08, 0x12, 0x10, 0x13, 0x22, 0x85, 0x01, 0x0a, 0x14, 0x57, 0x61, 0x6b, 0x65,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x74, 0x43, 0x61, 0x22, 0xa2,
	...
	0x61, 0x74, 0x65, 0x22, 0x4a, 0x0a, 0x19, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53,
	...
	0x69, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x63, 0x0a, 0x19, 0x53,
	...
	0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2a, 0xc5,
	...
	0x54, 0x49, 0x4e, 0x47, 0x10, 0x09, 0x32, 0xfb, 0x0a, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x70, 0x75,
...
var file_compute_proto_goTypes = []interface{}{
	...
	(*TLSCertificate)(nil),                           // 17: api.public.compute.TLSCertificate
	(*RegisterSatelliteRequest)(nil),                 // 18: api.public.compute.RegisterSatelliteRequest
	(*RegisterSatelliteResponse)(nil),                // 19: api.public.compute.RegisterSatelliteResponse
	(*DeregisterSatelliteRequest)(nil),               // 20: api.public.compute.DeregisterSatelliteRequest
	(*DeregisterSatelliteResponse)(nil),              // 21: api.public.compute.DeregisterSatelliteResponse
	(*SatelliteHeartbeatRequest)(nil),                // 22: api.public.compute.SatelliteHeartbeatRequest
	(*SatelliteHeartbeatResponse)(nil),               // 23: api.public.compute.SatelliteHeartbeatResponse
	(*ListSatellitesResponse_SatelliteInstance)(nil), // 24: api.public.compute.ListSatellitesResponse.SatelliteInstance
	(*ReserveSatelliteRequest_Metadata)(nil),         // 25: api.public.compute.ReserveSatelliteRequest.Metadata
...
var file_compute_proto_depIdxs = []int32{
	...
	24, // 1: api.public.compute.ListSatellitesResponse.instances:type_name -> api.public.compute.ListSatellitesResponse.SatelliteInstance
	0,  // 2: api.public.compute.GetSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	26, // 3: api.public.compute.GetSatelliteResponse.cache_retention:type_name -> google.protobuf.Duration
	27, // 4: api.public.compute.GetSatelliteResponse.last_used:type_name -> google.protobuf.Timestamp
	17, // 5: api.public.compute.GetSatelliteResponse.certificate:type_name -> api.public.compute.TLSCertificate
	26, // 6: api.public.compute.WakeSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	0,  // 7: api.public.compute.WakeSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	26, // 8: api.public.compute.SleepSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	0,  // 9: api.public.compute.SleepSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	26, // 10: api.public.compute.ReserveSatelliteRequest.update_interval:type_name -> google.protobuf.Duration
	25, // 11: api.public.compute.ReserveSatelliteRequest.metadata:type_name -> api.public.compute.ReserveSatelliteRequest.Metadata
	0,  // 12: api.public.compute.ReserveSatelliteResponse.status:type_name -> api.public.compute.SatelliteStatus
	17, // 13: api.public.compute.RegisterSatelliteRequest.certificate:type_name -> api.public.compute.TLSCertificate
	0,  // 14: api.public.compute.ListSatellitesResponse.SatelliteInstance.status:type_name -> api.public.compute.SatelliteStatus
	26, // 15: api.public.compute.ListSatellitesResponse.SatelliteInstance.cache_retention:type_name -> google.protobuf.Duration
	27, // 16: api.public.compute.ListSatellitesResponse.SatelliteInstance.last_used:type_name -> google.protobuf.Timestamp
	1,  // 17: api.public.compute.Compute.LaunchSatellite:input_type -> api.public.compute.LaunchSatelliteRequest
	3,  // 18: api.public.compute.Compute.ListSatellites:input_type -> api.public.compute.ListSatellitesRequest
	5,  // 19: api.public.compute.Compute.UpdateSatellite:input_type -> api.public.compute.UpdateSatelliteRequest
	7,  // 20: api.public.compute.Compute.DeleteSatellite:input_type -> api.public.compute.DeleteSatelliteRequest
	9,  // 21: api.public.compute.Compute.GetSatellite:input_type -> api.public.compute.GetSatelliteRequest
	18, // 22: api.public.compute.Compute.RegisterSatellite:input_type -> api.public.compute.RegisterSatelliteRequest
	20, // 23: api.public.compute.Compute.DeregisterSatellite:input_type -> api.public.compute.DeregisterSatelliteRequest
	22, // 24: api.public.compute.Compute.SatelliteHeartbeat:input_type -> api.public.compute.SatelliteHeartbeatRequest
	11, // 25: api.public.compute.Compute.WakeSatellite:input_type -> api.public.compute.WakeSatelliteRequest
	13, // 26: api.public.compute.Compute.SleepSatellite:input_type -> api.public.compute.SleepSatelliteRequest
	15, // 27: api.public.compute.Compute.ReserveSatellite:input_type -> api.public.compute.ReserveSatelliteRequest
	2,  // 28: api.public.compute.Compute.LaunchSatellite:output_type -> api.public.compute.LaunchSatelliteResponse
	4,  // 29: api.public.compute.Compute.ListSatellites:output_type -> api.public.compute.ListSatellitesResponse
	6,  // 30: api.public.compute.Compute.UpdateSatellite:output_type -> api.public.compute.UpdateSatelliteResponse
	8,  // 31: api.public.compute.Compute.DeleteSatellite:output_type -> api.public.compute.DeleteSatelliteResponse
	10, // 32: api.public.compute.Compute.GetSatellite:output_type -> api.public.compute.GetSatelliteResponse
	19, // 33: api.public.compute.Compute.RegisterSatellite:output_type -> api.public.compute.RegisterSatelliteResponse
	21, // 34: api.public.compute.Compute.DeregisterSatellite:output_type -> api.public.compute.DeregisterSatelliteResponse
	23, // 35: api.public.compute.Compute.SatelliteHeartbeat:output_type -> api.public.compute.SatelliteHeartbeatResponse
	12, // 36: api.public.compute.Compute.WakeSatellite:output_type -> api.public.compute.WakeSatelliteResponse
	14, // 37: api.public.compute.Compute.SleepSatellite:output_type -> api.public.compute.SleepSatelliteResponse
	16, // 38: api.public.compute.Compute.ReserveSatellite:output_type -> api.public.compute.ReserveSatelliteResponse
